...
search_terms = [
    "https://www.linkedin.com/jobs/collections/top-applicant/",   # LinkedIn Top Picks for You (no keyword filter)
    "AI Engineer", "ML Engineer", "AI Automation Engineer", "Backend Engineer", "Software Engineer", "Machine Learning Engineer", "LLM Engineer", "AI Agent Developer"
]
...
switch_number = 1                  # Round-robin: 1 job per search term per cycle (cycles repeat in run())
...
date_posted = ""                   # Using URL param f_TPR=r18000 (last 5 hrs) instead — set to "" to avoid conflict
...
about_company_bad_words = ["Crossover", "Staffing", "Outsourcing"]  # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
bad_words = [
    # Citizenship-only restrictions
    "US Citizen only", "Must be a US Citizen", "Must be US Citizen", "U.S. Citizen only",
    "Applicants must be US citizens", "Only US citizens", "citizenship is required",
    "US Citizenship required", "USA Citizen",
    # No visa sponsorship
    "no sponsorship", "not able to sponsor", "cannot sponsor", "unable to sponsor",
    "will not sponsor", "does not sponsor", "sponsorship not available",
    "sponsorship is not available", "not eligible for sponsorship",
    "visa sponsorship is not offered", "not provide sponsorship",
    # Tech stack mismatches
    "No C2C", "No Corp2Corp", ".NET developer", "Embedded Programming", "PHP", "Ruby on Rails", "CNC",
    # Security
    "Security Clearance", "Polygraph", "Active Clearance", "Top Secret",
]

# Job TITLE words that instantly skip the job (checked before even opening it — fast)
# Skips over-leveled roles: Staff, Principal, Director, VP, Lead Architect etc.
title_bad_words = [
    "Staff Engineer", "Principal Engineer", "Principal Scientist", "Staff Scientist",
    "Senior Staff", "Distinguished Engineer", "Fellow ",
    "VP ", "Vice President", "Director of", "Head of ", "Engineering Manager",
    "Chief ", "CTO", "C-Level",
]
